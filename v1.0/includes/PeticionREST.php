...
class PeticionREST
{
    ...
    public function __construct($separador = 'v1.0')
    {
        ...
        $this->agregarEncabezadosCORS();
    }

    /**
     * Añadir encabezados CORS para permitir solicitudes desde cualquier origen.
     */
    private function agregarEncabezadosCORS()
    {
        // Permitir solicitudes desde cualquier origen
        header("Access-Control-Allow-Origin: *");
        // Habilitar los métodos que se van a permitir
        header("Access-Control-Allow-Methods: GET, POST, PUT, DELETE");
        // Permitir incluir encabezados en la solicitud
